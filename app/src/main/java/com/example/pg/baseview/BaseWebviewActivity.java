...
public abstract class BaseWebviewActivity extends BaseActivity {
    ...
    protected void initWebView() {
        ...
        // 开始自定义UserAgent
        setting.setUserAgentString(setting.getUserAgentString() + AndroidUtil.getCustomUserAgent(mActivity));
